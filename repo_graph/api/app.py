...
from repo_graph.api.dependencies import init_dependencies
from repo_graph.api.routes import graph as graph_routes
from repo_graph.api.routes import overlays as overlay_routes
from repo_graph.api.websocket import router as ws_router
from repo_graph.graph.store import GraphStore
from repo_graph.mcp.server import create_mcp_server
...
def create_app(store: GraphStore, repo_root: str) -> FastAPI:
    ...
    async def lifespan(app: FastAPI) -> AsyncIterator[None]:
        from repo_graph.api.watcher import start_watcher
