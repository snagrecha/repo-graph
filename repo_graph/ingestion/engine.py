...
from repo_graph.graph.schema import Edge, Node
...
from repo_graph.plugins.loader import PluginManager
...
class IngestionEngine:
    ...
    def __init__(self, repo_root: str | Path, db_path: str | Path) -> None:
        ...
        self.plugins = PluginManager(self.repo_root / ".repo-graph" / "plugins")
